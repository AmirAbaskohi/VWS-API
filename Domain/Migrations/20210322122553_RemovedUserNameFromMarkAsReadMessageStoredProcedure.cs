...
{
    public partial class RemovedUserNameFromMarkAsReadMessageStoredProcedure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			migrationBuilder.Sql(@"ALTER PROCEDURE MarkUnreadMessages
@MessageId BIGINT,
...
END");
        ...
        {
			migrationBuilder.Sql(@"CREATE PROCEDURE MarkUnreadMessages
@MessageId BIGINT,
@UserId UNIQUEIDENTIFIER,
