...
{
    public partial class UpdateMarkMessageAsReadSP2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"ALTER PROCEDURE [dbo].[MarkUnreadMessages]
                                ...
                                WHERE m.Id <= @MessageId
									  ...
									  AND NOT EXISTS (SELECT * FROM dbo.Chat_MessageRead redundantMr WHERE redundantMr.MessageId = mr.MessageId AND redundantMr.ReadBy = mr.ReadBy);
