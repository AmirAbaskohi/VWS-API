...
namespace vws.web.Controllers._account
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> SetNickName([FromBody] NickNameModel model)
        {
            ...
            Task.Run(async () => await _emailSender.SendEmailAsync(emailModel, out string emailErrorMessage));
        ...
        public IActionResult SetFirstCalander(byte calendar)
        {
            ...
            {
                response.Message = "Invalid calender";
                response.AddError(_localizer["Invalid calnder."]);
                return StatusCode(StatusCodes.Status400BadRequest, response);
            }
